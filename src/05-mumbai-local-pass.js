...
Pass ID: ${passenger.classType[0].toUpperCase()}${passenger.from.slice(0, 3).toUpperCase()}${passenger.to.slice(0, 3).toUpperCase()}`;
}
console.log(
  generateLocalPass({ name: "rahul sharma", from: "dadar", to: "andheri", classType: "second" }),
);
